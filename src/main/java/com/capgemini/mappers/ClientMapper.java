...
public class ClientMapper {
	...
	public static ClientTO map2TO(ClientEntity clientEntity){
		...
		.addres(clientEntity.getAddres())
		.phone(clientEntity.getPhone())
		.email(clientEntity.getEmail())
		.creditCard(clientEntity.getCreditCard())
		.build();
	}
	...
	public static ClientEntity map2Entity(ClientTO clientTO){
		...
		.dateOfBirth(clientTO.getDateOfBirth())
		.addres(clientTO.getAddres())
		.phone(clientTO.getPhone())
		.email(clientTO.getEmail())
		.creditCard(clientTO.getCreditCard())
		.build();
	}
